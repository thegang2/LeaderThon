...
class Config(object):
    LOGGER = True
    ALIVE_NAME = os.environ.get("ALIVE_NAME", "@iqLeaderThon")
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/thegang2/LeaderThon")
    AUTONAME = os.environ.get("AUTONAME", "@iqLeaderThon")
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "iqLeaderThon")
    THUMB_IMAGE = os.environ.get("THUMB_IMAGE", "https://telegra.ph/file/46cc087ec231116cf18d1.jpg")
