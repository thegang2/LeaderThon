        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text += f" عذرا قم بكتابه الأمر بشكل صحيح راجع : @iqLeaderThon ** "
                        await check.client.send_message(
                            Config.PRIVATE_GROUP_BOT_API_ID, text, link_preview=False
                        )

            from .session import iqLeaderThon
            ...
            if pattern is not None:
                ...
                if edited:
                    iqLeaderThon.add_event_handler(
                        wrapper,
                ...
                if edited:
                    iqLeaderThon.add_event_handler(func, events.MessageEdited(**kwargs))
                iqLeaderThon.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                iqLeaderThon.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                iqLeaderThon.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
