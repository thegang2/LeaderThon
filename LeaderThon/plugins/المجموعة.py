...
@iqLeaderThon.on(admin_cmd(pattern=r"المحظورين?(.*)"))
...
@iqLeaderThon.on(admin_cmd(pattern="تشفير الملف ?(.*)"))
async def pyZip(e):
    if e.fwd_from:
        return
    ...
    zip_ = f"{nem_}.zip" if nem_ else "iqLeaderThon_Zip.zip"
    password = pass_ if pass_ else "iqLeaderThon"
...
@iqLeaderThon.on(admin_cmd(pattern=f"{MUTE}(?:\s|$)([\s\S]*)"))
async def muteiqLeaderThon(event):
    if event.is_private:
        ...
        if event.chat_id == iqLeaderThon.uid:
...
@iqLeaderThon.on(admin_cmd(pattern=f"{UNMUTE}(?:\s|$)([\s\S]*)"))
async def unmuteiqLeaderThon(event):
    if event.is_private:
        replied_user = await event.client.get_entity(event.chat_id)
...
@iqLeaderThon.on(admin_cmd(pattern=r"المشرفين(?: |$)(.*)"))
async def _(event):
...
@iqLeaderThon.on(admin_cmd(pattern=r"البوتات?(.*)"))
async def _(event):
...
@iqLeaderThon.on(admin_cmd(pattern=r"الأعضاء(?: |$)(.*)"))
...
@iqLeaderThon.on(admin_cmd(pattern=r"معلومات(?: |$)(.*)"))
...
@iqLeaderThon.on(admin_cmd(pattern=f"{addition} ?(.*)"))
async def iq(event):
    ...
    iqLeaderThon = await get_chatinfo(event)
    chat = await event.get_chat()
    if event.is_private:
    ...
    async for user in event.client.iter_participants(iqLeaderThon.full_chat.id):
        try:
...
@iqLeaderThon.on(admin_cmd(pattern=f"{TFLASH}(.*)"))
async def _(event):
    ...
    iqLeaderThonevent = await edit_or_reply(event, "**🝳 ⦙  جاري تفليش مجموعتك أنتظر قليلآ 🚮**")
    ...
    async for user in event.client.iter_participants(event.chat_id):
        ...
        try:
            ...
            LOGS.info(str(e))
    await iqLeaderThonevent.edit(f"**🝳 ⦙   تم بنجاح تفليش مجموعتك من {total} الاعضاء 🚮**")
    
async def ban_user(chat_id, i, rights):
    try:
        await iqLeaderThon(functions.channels.EditBannedRequest(chat_id, i, rights))
        return True, None
    except Exception as exc:
        return False, str(exc)


@iqLeaderThon.on(admin_cmd(pattern=f"{LEFT}(.*)"))
async def kickme(leave):
    await leave.edit("**🝳 ⦙   جـاري مـغادرة المجـموعة مـع السـلامة  🚶‍♂️  ..**")
    await leave.client.kick_participant(leave.chat_id, "me")

@iqLeaderThon.on(admin_cmd(pattern=f"{REMOVEBAN}(.*)"))
async def _(event):
...
@iqLeaderThon.on(admin_cmd(pattern=f"المحذوفين ?([\s\S]*)"))
...
@iqLeaderThon.on(admin_cmd(pattern=r"احصائيات الاعضاء ?([\s\S]*)"))
...
@iqLeaderThon.on(admin_cmd(pattern="تقيد(?:\s|$)([\s\S]*)",))
...
@iqLeaderThon.iq_cmd(pattern="اكتم(?:\s|$)([\s\S]*)",)
...
@iqLeaderThon.on(admin_cmd(pattern=r"احظر(?:\s|$)([\s\S]*)",))
...
@iqLeaderThon.on(admin_cmd(pattern=r"حظر عام(?:\s|$)([\s\S]*)",))
...
@iqLeaderThon.on(admin_cmd(pattern=r"الغاء حظر العام(?:\s|$)([\s\S]*)",))
...
@iqLeaderThon.on(admin_cmd(pattern=r"المحظورين عام$",))
async def gablist(event):
    gbanned_users = gban_sql.get_all_gbanned()
    GBANNED_LIST = "Current Gbanned Users\n"
    if len(gbanned_users) > 0:
...
@iqLeaderThon.on(admin_cmd(pattern=r"معلومات تخزين المجموعه(?:\s|$)([\s\S]*)"))
async def _(event):  # sourcery no-metrics
    reply = await event.get_reply_message()
    input_str = event.pattern_match.group(1)
...
@iqLeaderThon.iq_cmd(incoming=True, func=lambda e: e.is_private, edited=False, forword=None)
...
@iqLeaderThon.iq_cmd(incoming=True, func=lambda e: e.mentioned, edited=False, forword=None)
...
@iqLeaderThon.on(admin_cmd(pattern=r"تخزين الخاص (تشغيل|ايقاف)$"))
...
@iqLeaderThon.on(admin_cmd(pattern=r"تخزين الكروبات (تشغيل|ايقاف)$"))
...
@iqLeaderThon.on(admin_cmd(pattern=f"{LINKK} ?(.*)"))
async def iq(SLQ):
...
@iqLeaderThon.on(admin_cmd(pattern="عدد رسائلي ?(.*)"))
async def iq(SLQ):
...
@iqLeaderThon.on(admin_cmd(pattern="تغير صورة( المجموعة| -d)$"))
...
@iqLeaderThon.on(admin_cmd(pattern=f"{ADMINRAISE}(?: |$)(.*)"))
...
@iqLeaderThon.on(admin_cmd(pattern=f"{UNADMINRAISE}(?: |$)(.*)"))
...
@iqLeaderThon.on(admin_cmd(pattern="تثبيت(?: |$)(.*)"))
async def pin(event):
    "🝳 ⦙   تثبيت  📌"
...
@iqLeaderThon.on(admin_cmd(pattern="الغاء التثبيت(?: |$)(.*)"))
async def pin(event):
...
@iqLeaderThon.on(admin_cmd(pattern="جلب الاحداث(?: |$)(.*)"))
...
moment_worker = []
@iqLeaderThon.on(admin_cmd(outgoing=True, pattern="all?(.*)"))
async def mentionall(event):
  ...
  if mode == "text_on_cmd":
    ...
    usrnum = 0
    usrtxt = ""
    async for usr in iqLeaderThon.iter_participants(event.chat_id):
      usrnum += 1
      ...
      if event.chat_id not in moment_worker:
        ...
        return
      if usrnum == 5:
        await iqLeaderThon.send_message(event.chat_id, f"{usrtxt}\n\n{msg}")
  ...
  if mode == "text_on_reply":
    ...
    async for usr in iqLeaderThon.iter_participants(event.chat_id):
      ...
      if event.chat_id not in moment_worker:
        ...
        return
      if usrnum == 5:
        await iqLeaderThon.send_message(event.chat_id, usrtxt, reply_to=msg)
        await asyncio.sleep(2)
        usrnum = 0
        usrtxt = ""

@iqLeaderThon.on(admin_cmd(outgoing=True, pattern="ايقاف التاك?(.*)"))
...
@iqLeaderThon.on(admin_cmd(pattern=f"{BANDD}(?: |$)(.*)"))
...
@iqLeaderThon.on(admin_cmd(pattern=r"zip(?:\s|$)([\s\S]*)"))
...
@iqLeaderThon.on(admin_cmd(pattern=r"unzip(?:\s|$)([\s\S]*)"))
...
@iqLeaderThon.on(admin_cmd(pattern="معرفه(?: |$)(.*)"))
...
@iqLeaderThon.on(admin_cmd(pattern="دعوه للمكالمه(?: |$)(.*)"))
async def _(e):
...
@iqLeaderThon.on(admin_cmd(pattern="بدء مكالمه(?: |$)(.*)"))
async def _(e):
    try:
...
@iqLeaderThon.on(admin_cmd(pattern=f"{UNBANDD}(?: |$)(.*)"))
...
async def watcher(event):
    if is_muted(event.sender_id, event.chat_id):
        try:
            ...
            LOGS.info(str(e))
@iqLeaderThon.on(admin_cmd(pattern="صنع (مجموعه|قناه) (.*)"))
async def iq(event):
...
@iqLeaderThon.on(admin_cmd(pattern="تلقائي ?(.*)"))
async def _(event):
...
@iqLeaderThon.on(admin_cmd(pattern="الغاء_التلقائي ?(.*)"))
async def _(event):
    if (event.is_private or event.is_group):
        return await edit_or_reply(event, "امر التلقائي يستخدم فقط للقنوات.")
    hel_ = event.pattern_match.group(1)
...
@iqLeaderThon.on(admin_cmd(pattern=r"جلب الصور(?:\s|$)([\s\S]*)"))
async def potocmd(event):
    ...
    if uid.strip() == "":
        ...
        await event.client.send_file(event.chat_id, send_photos)
    await event.delete()
@iqLeaderThon.on(admin_cmd(pattern="تفعيل ([\s\S]*)"))    
async def _(event):  
    input_str = event.pattern_match.group(1)
...
@iqLeaderThon.on(admin_cmd(pattern="تعطيل ([\s\S]*)"))    
async def _(event):  
    input_str = event.pattern_match.group(1)
    peer_id = event.chat_id
    if not event.is_group:
...
@iqLeaderThon.on(admin_cmd(pattern="صلاحيات المجموعه$"))    
async def _(event):  
    res = ""
