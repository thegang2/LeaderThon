...
from . import iqLeaderThon, BOTLOG, BOTLOG_CHATID, ALIVE_NAME, covidindia, make_gif, hmention, progress, reply_id, ytsearch, reply_id, convert_toimage , deEmojify, phcomment,threats, trap, trash  
from pytz import country_names as c_n
from pytz import country_timezones as c_tz
from pytz import timezone as tz
...
FONT_FILE_TO_USE = "iqLeaderThon/helpers/styles/impact.ttf"
...
@iqLeaderThon.on(admin_cmd(pattern="جلب لقطات(?:\s|$)([\s\S]*)"))    
async def collage(event):
    ...
    for files in (catsticker, collagefile, endfile):
        if files and os.path.exists(files):
            os.remove(files)
@iqLeaderThon.on(admin_cmd(pattern=r"رابط تطبيق ([\s\S]*)"))
...
@iqLeaderThon.on(events.NewMessage(outgoing=False, pattern=r'العمر ?(.*)'))
...
@iqLeaderThon.on(admin_cmd(pattern="الوقت(?:\s|$)([\s\S]*)(?<![0-9])(?: |$)([0-9]+)?"))
...
@iqLeaderThon.on(admin_cmd(pattern="وقتي(?:\s|$)([\s\S]*)"))
async def _(event):
    ...
    await event.delete()
@iqLeaderThon.on(admin_cmd(pattern=r"الاذان(?: |$)(.*)"))
async def get_adzan(adzan):
    ...
    iqLeaderThonresult = f"<b>اوقـات صـلاه المـسلمين 👳‍♂️ </b>\
    ...
    "
    await edit_or_reply(adzan, iqLeaderThonresult, "html")
@iqLeaderThon.on(admin_cmd(pattern=r"كورونا(?:\s|$)([\s\S]*)"))
...
@iqLeaderThon.on(admin_cmd(pattern=r"بحث(320)?(?:\s|$)([\s\S]*)"))
async def _(event):
    "To search songs"
...
@iqLeaderThon.on(admin_cmd(pattern=r"فيديو(?:\s|$)([\s\S]*)"))
async def _(event):
    reply_to_id = await reply_id(event)
    reply = await event.get_reply_message()
    ...
    for files in (catthumb, vsong_file):
        if files and os.path.exists(files):
            os.remove(files)
@iqLeaderThon.on(admin_cmd(pattern=r"معلومات الاغنيه(?: |$)(.*)"))
async def shazamcmd(event):
    ...
    await catevent.delete()
@iqLeaderThon.on(admin_cmd(pattern=r"كوكل بحث ([\s\S]*)"))
...
@iqLeaderThon.on(admin_cmd(pattern=r"البحث العام(?: |$)(.*)"))
async def _(event):
    start = datetime.now()
...
@iqLeaderThon.on(admin_cmd(pattern=r"البحث اونلاين(?:\s|$)([\s\S]*)"))
async def google_search(event):
    ...
    await event.delete()
@iqLeaderThon.on(admin_cmd(pattern="تخزين الصوت(?: |$)(.*)"))
async def iq(event):
...
@iqLeaderThon.on(admin_cmd(pattern="اضف الصوت(?: |$)(.*)"))
async def iq(event):
    ureply = await event.get_reply_message()
...
@iqLeaderThon.on(admin_cmd(pattern="تحويل صوره(?: |$)(.*)"))
async def _(event):
    reply_to_id = await reply_id(event)
    reply = await event.get_reply_message()
    if not reply:
...
@iqLeaderThon.on(admin_cmd(pattern="تحويل ملصق(?: |$)(.*)"))
async def _(event):
    reply_to_id = await reply_id(event)
    reply = await event.get_reply_message()
    if not reply:
    ...
    await output[0].delete()
@iqLeaderThon.on(admin_cmd(pattern="تحويل (صوت|بصمه)(?: |$)(.*)"))
async def _(event):
    ...
    try:
        ...
        if os.path.exists(new_required_file_name):
            ...
            await event.delete()
@iqLeaderThon.on(admin_cmd(pattern="تحويل متحركة ?([0-9.]+)?$"))
async def _(event):
    reply = await event.get_reply_message()
    ...
    for i in [inputfile, outputfile]:
        if os.path.exists(i):
            os.remove(i)
@iqLeaderThon.on(admin_cmd(pattern="تحويل فديو دائري(?: |$)((-)?(s)?)$"))
async def pic_gifcmd(event):  # sourcery no-metrics
    ...
    for i in [final, "Output.gif", meme_file, PATH, final]:
        if os.path.exists(i):
            os.remove(i)
@iqLeaderThon.on(admin_cmd(pattern="تحويل ملصق دائري ?((-)?s)?$"))
async def video_catfile(event):  # sourcery no-metrics
    ...
    await catevent.delete()
@iqLeaderThon.on(admin_cmd(pattern="تحويل ملف ([\s\S]*)"))
async def get(event):
    name = event.text[5:]
    if name is None:
    ...
    if m.text:
        ...
        await edit_or_reply(event, "**🝳 ⦙ قم بالـرد على الرسالـة لتحويلها الى ملف**")
@iqLeaderThon.on(admin_cmd(pattern="بورن(?:\s|$)([\s\S]*)"))
...
@iqLeaderThon.on(admin_cmd(pattern="(طقس|الطقس)(?:\s|$)([\s\S]*)"))    
...
@iqLeaderThon.on(admin_cmd(pattern="تحويل رساله(?: |$)(.*)"))
async def get(event):
    reply = await event.get_reply_message()
    mediatype = media_type(reply)
    ...
    if os.path.exists(file_loc):
        os.remove(file_loc)
@iqLeaderThon.on(admin_cmd(pattern="تحويل ملف صوره(?: |$)(.*)"))
async def on_file_to_photo(event):
    ...
    try:
        ...
        return
    await catt.delete()
@iqLeaderThon.on(admin_cmd(pattern="تحويل ملصق متحرك(?:\s|$)([\s\S]*)"))
async def _(event):  # sourcery no-metrics
    ...
    for files in (catgif, catfile):
        if files and os.path.exists(files):
            os.remove(files)
@iqLeaderThon.on(admin_cmd(pattern="تحويل متحركه(?: |$)((-)?(r|l|u|d|s|i)?)$"))
async def pic_gifcmd(event):  # sourcery no-metrics
    reply = await event.get_reply_message()
    mediatype = media_type(reply)
    ...
    for i in [final, "Output.gif", imag[1]]:
        if os.path.exists(i):
            os.remove(i)
@iqLeaderThon.on(admin_cmd(pattern="مدينه الطقس(?:\s|$)([\s\S]*)"))    
...
@iqLeaderThon.on(admin_cmd(pattern=r"(ت(لي)?ج(راف)?) ?(م|ك|ميديا|كتابه)(?:\s|$)([\s\S]*)"))
async def _(event):
...
@iqLeaderThon.on(admin_cmd(pattern="تحويل فديو متحركه ?([0-9.]+)?$"))
async def _(event):
    reply = await event.get_reply_message()
    mediatype = media_type(event)
    if mediatype and mediatype != "video":
    ...
    for i in [inputfile, outputfile]:
        if os.path.exists(i):
            os.remove(i)
@iqLeaderThon.on(admin_cmd(pattern="طقوس(?:\s|$)([\s\S]*)"))    
async def _(event):
    reply_to_id = await reply_id(event)
    input_str = event.pattern_match.group(1)
    if not input_str:
