...
def build_keyboard(buttons):
    ...
    return keyb
@iqLeaderThon.on(admin_cmd(pattern="وقتيه (\d*) ([\s\S]*)"))    
async def _(event):
...
async def all_groups_id(cat):
    ...
    return catgroups
@iqLeaderThon.on(admin_cmd(pattern="ازاله التوجيه(?: |$)(.*)"))    
async def _(event):
    try:
        await event.delete()
...
@iqLeaderThon.on(admin_cmd(pattern=f"{ALLGROUB} ?(.*)$"))    
...
async def getTranslate(text, **kwargs):
    ...
    for _ in range(10):
        try:
            ...
            await sleep(0.1)
    return result
@iqLeaderThon.iq_cmd(incoming=True, groups_only=True)
async def _(event):
    if not CHAT_FLOOD:
        return
...
@iqLeaderThon.on(admin_cmd(pattern=f"{ALLPRIVATE} ?(.*)$"))    
...
@iqLeaderThon.on(admin_cmd(pattern="كتابه وهمي(?:\s|$)([\s\S]*)"))
async def _iq(iqLeaderThon):
    iq = iqLeaderThon.pattern_match.group(1)
    if not (iq or iq.isdigit()):
        ...
        try:
            ...
            try:
                iq = await iqLeaderThon.ban_time(iq)
            except BaseException:
                return await event.edit("**اكتب الامر بشكل صحيح**")
    await iqLeaderThon.edit(f"**تم بدء وضع الكتابة الوهمية لـ {iq} من الثوانـي**")
    async with iqLeaderThon.client.action(iqLeaderThon.chat_id, "typing"):
        await asyncio.sleep(iq)
@iqLeaderThon.on(admin_cmd(pattern="تكرار (.*)"))    
...
@iqLeaderThon.on(admin_cmd(pattern="مؤقته (\d*) ([\s\S]*)"))    
async def selfdestruct(destroy):
    ...
    await sleep(ttl)
    await smsg.delete()
def iqLeaderThonveFile(input_file_name):
...
@iqLeaderThon.on(admin_cmd(pattern="ترحيب(?:\s|$)([\s\S]*)"))    
...
@iqLeaderThon.on(admin_cmd(pattern="مسح الترحيبات(?: |$)(.*)"))    
...
@iqLeaderThon.on(admin_cmd(pattern="ترحيباتي(?: |$)(.*)"))    
...
@iqLeaderThon.on(admin_cmd(pattern="رساله الترحيب السابقه (تشغيل|ايقاف)$"))    
async def del_welcome(event):
...
@iqLeaderThon.on(admin_cmd(pattern="موقع(?: |$)(.*)"))    
async def gps(event):
    reply_to_id = await reply_id(event)
    input_str = event.pattern_match.group(1)
    catevent = await edit_or_reply(event, "** 🝳 ⦙   جاري العثـور على الموقع  … **")
    geolocator = Nominatim(user_agent="catiqLeaderThon")
...
async def ocr_iqLeaderThon(filename, overlay=False,api_key="K88942796188957", language="eng"):
    payload = {"isOverlayRequired": overlay,"apikey": api_key,"language": language}
    with open(filename, "rb") as f:
        r = requests.post("https://api.ocr.space/parse/image",files={filename: f},data=payload)
    return r.json()
@iqLeaderThon.on(admin_cmd(pattern="فيديو وهمي(?:\s|$)([\s\S]*)"))
async def _iq(iqLeaderThon):
    iq = iqLeaderThon.pattern_match.group(1)
    if not (iq or iq.isdigit()):
        iq = 100
        ...
        try:
            ...
            try:
                ...
                return await event.edit("**اكتب الامر بشكل صحيح**")
    await iqLeaderThon.edit(f"**تم بدء وضع فيديو وهمي لـ {iq} من الثوانـي**")
    async with iqLeaderThon.client.action(iqLeaderThon.chat_id, "record-video"):
        await asyncio.sleep(iq)
@iqLeaderThon.on(admin_cmd(pattern="ازعاج(?: |$)(.*)"))    
...
@iqLeaderThon.on(admin_cmd(pattern="الغاء الازعاج( -a)?"))    
async def echo(event):
    input_str = event.pattern_match.group(1)
    if input_str:
        lecho = get_all_echos()
        ...
        try:
            ...
            await edit_or_reply(event, "**🝳 ⦙   تـم ايقاف وضـع الازعاج على الجميع بنجاح ✅**")
@iqLeaderThon.on(admin_cmd(pattern="المزعجهم( -a)?$"))    
async def echo(event):  
    input_str = event.pattern_match.group(1)
    private_chats = ""
    ...
    if not (iq or iq.isdigit()):
        ...
        try:
            ...
            try:
                ...
                return await event.edit("**اكتب الامر بشكل صحيح**")
    await iqLeaderThon.edit(f"**تم بدء وضع صوت وهمي لـ {iq} من الثوانـي**")
    async with iqLeaderThon.client.action(iqLeaderThon.chat_id, "record-audio"):
        await asyncio.sleep(iq)
@iqLeaderThon.on(admin_cmd(pattern="تنظيف(?:\s|$)([\s\S]*)"))
...
@iqLeaderThon.on(admin_cmd(pattern="لعب وهمي(?:\s|$)([\s\S]*)"))
async def _iq(iqLeaderThon):
    iq = iqLeaderThon.pattern_match.group(1)
    if not (iq or iq.isdigit()):
        iq = 100
        ...
        try:
            ...
            try:
                ...
                return await event.edit("**اكتب الامر بشكل صحيح**")
    await iqLeaderThon.edit(f"**تم بدء وضع لعب وهمي لـ {iq} من الثوانـي**")
    async with iqLeaderThon.client.action(iqLeaderThon.chat_id, "game"):
        await asyncio.sleep(iq)  
@iqLeaderThon.iq_cmd(pattern="قرائه(?:\s|$)([\s\S]*)",)
async def ocriq(iqLeaderThonevent):
    iqqevent = await edit_or_reply(iqLeaderThonevent, "جاري قرائه الصوره ...")
    if not os.path.isdir(Config.TEMP_DIR):
        os.makedirs(Config.TEMP_DIR)
    lang_code = iqLeaderThonevent.pattern_match.group(1)
    downloaded_file_name = await iqLeaderThonevent.client.download_media(await iqLeaderThonevent.get_reply_message(), Config.TEMP_DIR)
    test_file = await ocr_iqLeaderThon(filename=downloaded_file_name, language=lang_code)
    try:
...
@iqLeaderThon.on(admin_cmd(pattern="اضف رد ([\s\S]*)")) 
...
@iqLeaderThon.on(admin_cmd(pattern="موقع وهمي(?:\s|$)([\s\S]*)"))
async def _iq(iqLeaderThon):
    iq = iqLeaderThon.pattern_match.group(1)
    if not (iq or iq.isdigit()):
        iq = 100
        ...
        try:
            ...
            try:
                ...
                return await event.edit("**اكتب الامر بشكل صحيح**")
    await iqLeaderThon.edit(f"**تم بدء وضع موقع وهمي لـ {iq} من الثوانـي**")
    async with iqLeaderThon.client.action(iqLeaderThon.chat_id, "location"):
        await asyncio.sleep(iq)
@iqLeaderThon.on(admin_cmd(pattern="جميع الردود(?: |$)(.*)"))    
...
@iqLeaderThon.on(admin_cmd(pattern="مسح رد ([\s\S]*)")) 
...
@iqLeaderThon.on(admin_cmd(pattern="مسح جميع الردود(?: |$)(.*)"))    
...
@iqLeaderThon.on(admin_cmd(pattern="تكلم(?:\s|$)([\s\S]*)"))    
async def _(event):
    input_str = event.pattern_match.group(1)
    start = datetime.now()
    reply_to_id = await reply_id(event)
...
@iqLeaderThon.on(admin_cmd(pattern="تحذير تكرار(?:\s|$)([\s\S]*)"))
async def _(event):
    input_str = event.pattern_match.group(1)
...
@iqLeaderThon.on(admin_cmd(pattern="ترجمه ([\s\S]*)"))
async def _(event):
    input_str = event.pattern_match.group(1)
    if event.reply_to_msg_id:
        previous_message = await event.get_reply_message()
...
@iqLeaderThon.on(admin_cmd(pattern=f"{FOTOSECRET}(?: |$)(.*)"))    
async def iq(event):
  ...
  await bot.send_file('me', pic, caption=f"""**الصـورة الوقتيه ✅**\- So : @iqLeaderThon""")
  await event.delete()
@iqLeaderThon.on(admin_cmd(pattern="تاريخ الرساله(?: |$)(.*)"))    
async def _(event):
...
@iqLeaderThon.on(admin_cmd(pattern="جهه اتصال وهمي(?:\s|$)([\s\S]*)"))
async def _iq(iqLeaderThon):
    iq = iqLeaderThon.pattern_match.group(1)
    if not (iq or iq.isdigit()):
        iq = 100
        ...
        try:
            ...
            try:
                ...
                return await event.edit("**اكتب الامر بشكل صحيح**")
    await iqLeaderThon.edit(f"**تم بدء وضع جهه اتصال وهمي لـ {iq} من الثوانـي**")
    async with iqLeaderThon.client.action(iqLeaderThon.chat_id, "contact"):
        await asyncio.sleep(iq)  
@iqLeaderThon.on(admin_cmd(pattern="ماركدون(?:\s|$)([\s\S]*)"))    
async def _(event):
    reply_to_id = await reply_id(event)
    ...
    await event.delete()
@iqLeaderThon.on(admin_cmd(pattern="حذف(?:\s|$)([\s\S]*)"))
async def iq(cloneiq):  
    chat = await cloneiq.get_input_chat()
    msgs = []
    count = 0
    ...
    await sleep(5)
    await hi.delete()
@iqLeaderThon.on(admin_cmd(pattern="معرفات 100(?: |$)(.*)"))
async def iq(iqLeaderThon):
    mentions = iqLeaderThon.text[8:]
    chat = await iqLeaderThon.get_input_chat()
    async for x in iqLeaderThon.client.iter_participants(chat, 100):
        mentions += f" - @{x.username} ⦙ "
    await iqLeaderThon.client.send_message(iqLeaderThon.chat_id, mentions)
    await iqLeaderThon.delete()
@iqLeaderThon.on(admin_cmd(pattern="معرفات 200(?: |$)(.*)"))
async def iq(iqLeaderThon):
    mentions = iqLeaderThon.text[8:]
    chat = await iqLeaderThon.get_input_chat()
    async for x in iqLeaderThon.client.iter_participants(chat, 200):
        mentions += f" - @{x.username} ⦙ "
    await iqLeaderThon.client.send_message(iqLeaderThon.chat_id, mentions)
    await iqLeaderThon.delete()
@iqLeaderThon.on(admin_cmd(pattern="تاك 200(?: |$)(.*)"))
async def iq(iqLeaderThon):
    mentions = iqLeaderThon.text[8:]
    chat = await iqLeaderThon.get_input_chat()
    async for x in iqLeaderThon.client.iter_participants(chat, 200):
    ...
    await iqLeaderThon.client.send_message(iqLeaderThon.chat_id, mentions)
    await iqLeaderThon.delete()
@iqLeaderThon.on(admin_cmd(pattern="تاك 150(?: |$)(.*)"))
async def iq(iqLeaderThon):
    mentions = iqLeaderThon.text[8:]
    chat = await iqLeaderThon.get_input_chat()
    async for x in iqLeaderThon.client.iter_participants(chat, 150):
        mentions += f" \n🝳 ⦙ ⵧ〈[{x.first_name}](tg://user?id={x.id})〉 \n"
    await iqLeaderThon.client.send_message(iqLeaderThon.chat_id, mentions)
    await iqLeaderThon.delete()
@iqLeaderThon.on(admin_cmd(pattern="تاك 100(?: |$)(.*)"))
async def iq(iqLeaderThon):
    mentions = iqLeaderThon.text[8:]
    chat = await iqLeaderThon.get_input_chat()
    async for x in iqLeaderThon.client.iter_participants(chat, 100):
    ...
    await iqLeaderThon.client.send_message(iqLeaderThon.chat_id, mentions)
    await iqLeaderThon.delete()
@iqLeaderThon.on(admin_cmd(pattern="تاك 50(?: |$)(.*)"))
async def iq(iqLeaderThon):
    mentions = iqLeaderThon.text[8:]
    chat = await iqLeaderThon.get_input_chat()
    async for x in iqLeaderThon.client.iter_participants(chat, 50):
        mentions += f" \n🝳 ⦙ ⵧ〈[{x.first_name}](tg://user?id={x.id})〉 \n"
    await iqLeaderThon.client.send_message(iqLeaderThon.chat_id, mentions)
    await iqLeaderThon.delete()
@iqLeaderThon.on(admin_cmd(pattern="تاك 10(?: |$)(.*)"))
async def iq(iqLeaderThon):
    mentions = iqLeaderThon.text[8:]
    chat = await iqLeaderThon.get_input_chat()
    async for x in iqLeaderThon.client.iter_participants(chat, 10):
        mentions += f" \n 🝳 ⦙ ⵧ〈[{x.first_name}](tg://user?id={x.id})〉 \n"
    await iqLeaderThon.client.send_message(iqLeaderThon.chat_id, mentions)
    await iqLeaderThon.delete()
@iqLeaderThon.on(admin_cmd(pattern="احسب ([\s\S]*)"))    
...
@iqLeaderThon.iq_cmd(pattern="(ازاله الخلفيه بالملصق|ازاله الخلفيه)(?:\s|$)([\s\S]*)",)
async def remove_iq(event):
    ...
    if event.reply_to_msg_id and not input_str:
        ...
        try:
            ...
            response = iqLeaderThonveFile(file_name)
            os.remove(file_name)
    elif input_str:
        catevent = await edit_or_reply(event, "إزالة خلفية هذه الوسائط")
        response = iqLeaderThonveURL(input_str)
    else:
    ...
    remove_bg_image = "iqLeaderThon.png"
    if "image" in contentType:
        with open("iqLeaderThon.png", "wb") as removed_bg_file:
            removed_bg_file.write(response.content)
    else:
        await edit_delete(catevent, f"`{response.content.decode('UTF-8')}`", 5)
        return
    if cmd == "ازاله الخلفيه بالملصق":
        file = convert_tosticker(remove_bg_image, filename="iqLeaderThon.webp")
    ...
    await catevent.delete()
@iqLeaderThon.on(admin_cmd(pattern="ابلاغ الادمنيه(?: |$)(.*)"))    
async def iq(event):
...
async def on_new_message(event):
    ...
    for snip in snips:
        ...
        if re.search(pattern, name, flags=re.IGNORECASE):
            ...
            break
@iqLeaderThon.on(admin_cmd(pattern="خط ملصق ?(?:(.*?) ?; )?([\s\S]*)"))    
async def sticklet(event):
    ...
    image_stream.name = "iqLeaderThon.webp"
    image.save(image_stream, "WebP")
    image_stream.seek(0)
    await event.client.send_file(        event.chat_id,        image_stream,        caption="iqLeaderThon's Sticklet",        reply_to=reply_to_id,    )
    try:
        os.remove(FONT_FILE)
    except BaseException:
        pass
@iqLeaderThon.on(admin_cmd(pattern="ضفدع(?:\s|$)([\s\S]*)"))    
...
@iqLeaderThon.on(admin_cmd(pattern="منع(?:\s|$)([\s\S]*)"))    
async def _(event):
    text = event.pattern_match.group(1)
...
@iqLeaderThon.on(admin_cmd(pattern="الغاء منع(?:\s|$)([\s\S]*)"))    
async def _(event):
    text = event.pattern_match.group(1)
...
@iqLeaderThon.on(admin_cmd(pattern="قائمه المنع$"))    
async def _(event):
...
@iqLeaderThon.on(admin_cmd(pattern="مسح(\s*| \d+)$"))
async def iq(msg1):
    ...
    if iq_src:
        ...
        await msg1.delete()
@iqLeaderThon.on(admin_cmd(pattern="تاك بالكلام ([\s\S]*)"))    
async def iq(event):
...
@iqLeaderThon.on(admin_cmd(pattern="لافته(?:\s|$)([\s\S]*)"))    
...
@iqLeaderThon.on(admin_cmd(pattern="نسخ(?: |$)(.*)"))
async def iq(nshkh):
    if nshkh.fwd_from:
        return
...
@iqLeaderThon.on(admin_cmd(pattern="غمق(?: |$)(.*)"))
async def iq(nshkh):
    if nshkh.fwd_from:
        return
    if nshkh.reply_to_msg_id:
        ...
        await nshkh.edit("**🝳 ⦙   قم  برد على الرساله ** ")
@iqLeaderThon.on(admin_cmd(pattern="ينسخ(?: |$)(.*)"))
async def iq(nshkh):
    if nshkh.fwd_from:
        return
    if nshkh.reply_to_msg_id:
        ...
        await nshkh.edit("**🝳 ⦙   قم  برد على الرساله ** ")
@iqLeaderThon.on(admin_cmd(pattern="خط سفلي(?: |$)(.*)"))
async def iq(nshkh):
    if nshkh.fwd_from:
        return
    if nshkh.reply_to_msg_id:
