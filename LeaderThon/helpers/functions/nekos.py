...
async def fakegs(search, result):
    ...
    blue = (0, 0, 255)
    black = (0, 0, 0)
    font1 = ImageFont.truetype("iqLeaderThon/helpers/styles/ProductSans-BoldItalic.ttf", 20)
    font2 = ImageFont.truetype("iqLeaderThon/helpers/styles/ProductSans-Light.ttf", 23)
