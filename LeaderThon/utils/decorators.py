...
def errors_handler(func):
    async def wrapper(errors):
        try:
            ...
            ftext = f"\n--------BEGIN iqLeaderThon TRACEBACK LOG--------\
            ...
            ftext += "\n\n--------END iqLeaderThon TRACEBACK LOG--------"
...
def register(**args):
    ...
    def decorator(func):
        if not disable_edited:
            iqLeaderThon.add_event_handler(func, MessageEdited(**args))
        iqLeaderThon.add_event_handler(func, NewMessage(**args))
        try:
